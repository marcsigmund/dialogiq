...
const steps = [
  {
    ...
    description:
      "Choose a partner you're comfortable with to practice and improve your language skills",
  },
  {
    icon: <MessageSquare className="w-6 h-6" />,
    title: "Start a conversation",
    description: "Choose a topic and learn by doing mistakes.",
  },
  {
    icon: <Volume2 className="w-6 h-6" />,
    title: "Speak naturally",
    description:
      "Talk as you would in a real conversation and get real-time feedback",
  },
  {
    icon: <Sparkles className="w-6 h-6" />,
    title: "Improve with feedback",
    description:
      "Review your conversation with detailed analysis and suggestions",
  },
];
...
const interests = [
  ...
  },
  {
    ...
    title: "Sales Skills",
    description:
      "Convince anyone to buy anything (except this app, it's free!)",
  },
  {
    id: "dating",
    ...
    description:
      "Because 'I speak five languages' sounds better than 'I live with my parents'",
  },
];
...
export const ExplainerScreen: React.FC<ExplainerScreenProps> = ({
  onNext,
  onBack,
}) => {
  ...
  const hasCompletedSelections =
    selectedInterests.length > 0 && selectedLanguages.length > 0;
  ...
  const nextPage = () => {
    ...
    if (currentPage === 1) {
      // Log the selections before moving to the next screen
      console.log("Onboarding Selections:", {
        ...
        interests: selectedInterests.map((interest) => {
          const interestDetails = interests.find((i) => i.id === interest);
          return {
            id: interest,
            title: interestDetails?.title,
          };
        }),
      });
    }
    ...
    <div className="space-y-6">
      ...
      {currentPage === 1 && (
        <div className="space-y-6 animate-in slide-in-from-right">
          ...
          <div
            className="pt-4 border-t animate-in fade-in"
            style={{ animationDelay: "300ms" }}
          >
            <h3 className="font-medium text-base mb-3">
              Which languages do you want to improve?
            </h3>
            <p className="text-sm text-muted-foreground mb-4">
      ...
      <div className="flex justify-between items-center pt-4 mt-auto">
        ...
        <Button
          ...
          className={cn(
            ...
            !(currentPage === 1 && !hasCompletedSelections) &&
              "hover:translate-x-1"
          )}
        >
